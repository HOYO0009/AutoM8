...
- [x] Automation Builder / prompt-to-draft-automation: block incomplete drafts with Clarification Questions before creating a Draft Automation and show safe diagnostics when model output cannot be validated.
