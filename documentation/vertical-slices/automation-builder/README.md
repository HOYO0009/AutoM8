...
- And file and spreadsheet Clarification Questions can use a local Windows picker while still submitting a normal Clarification Answer value
...
- And new draft creation and saved automation prompt edits share full Clarification Answer context, one bounded parsed-JSON/schema/semantic repair pass, and the shared draft validation boundary before generated drafts become UI-visible or saved automation data
