...
| Hybrid runner | The Windows-first runner that executes deterministic actions directly, pauses side effects for approval, and runs bounded LLM desktop tasks from screenshot and accessibility evidence. | Runner |
